...
export default function BoldFontsPage() {
  const [inputText, setInputText] = useState('Bold Fonts');
  
  const stylesByCategory = getStylesByCategory();
  const boldFonts = stylesByCategory['Bold Fonts'] || [];
      ...
      <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <div className="text-center mb-12">
          ...
          <p className="text-xl text-gray-600 mb-8">
            Strong and impactful fonts that command attention
          </p>
        ...
        <div className="bg-white rounded-lg shadow-sm p-8 mb-8">
          <h2 className="text-2xl font-bold text-gray-900 mb-4">About Bold Fonts</h2>
          <p className="text-gray-600 mb-4">
            Bold fonts are designed to make a strong visual impact and grab immediate attention. 
            These fonts feature thicker strokes and heavier weight, making them perfect for 
            headlines, important announcements, and any text that needs to stand out.
          </p>
