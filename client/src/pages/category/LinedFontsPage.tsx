...
export default function LinedFontsPage() {
  const [inputText, setInputText] = useState('Lined Fonts');
  
  const stylesByCategory = getStylesByCategory();
  const linedFonts = stylesByCategory['Lined Fonts'] || [];
      ...
      <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <div className="text-center mb-12">
          <h1 className="text-4xl font-bold text-gray-900 mb-4">
            Lined Fonts Generator
          </h1>
          <p className="text-xl text-gray-600 mb-8">
            Add emphasis with underlines, strikethroughs, and decorative lines
          </p>
        ...
        <div className="bg-white rounded-lg shadow-sm p-8 mb-8">
          <h2 className="text-2xl font-bold text-gray-900 mb-4">About Lined Fonts</h2>
          <p className="text-gray-600 mb-4">
            Lined fonts add visual emphasis through various line decorations like underlines, 
            strikethroughs, and overlines. These fonts are perfect for highlighting important 
            text or creating visual hierarchy in your content.
          </p>
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            <div>
              ...
              <ul className="text-gray-600 space-y-1">
                <li>• Multiple line styles</li>
                <li>• Clear emphasis</li>
