...
export default function GamingFontsPage() {
  const [inputText, setInputText] = useState('Gaming Fonts');
  
  const stylesByCategory = getStylesByCategory();
  const gamingFonts = stylesByCategory['Gaming Fonts'] || [];
      ...
      <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <div className="text-center mb-12">
          <h1 className="text-4xl font-bold text-gray-900 mb-4">
            Gaming Fonts Generator
          </h1>
          <p className="text-xl text-gray-600 mb-8">
            Level up your gaming identity with epic font styles
          </p>
        ...
        <div className="bg-white rounded-lg shadow-sm p-8 mb-8">
          <h2 className="text-2xl font-bold text-gray-900 mb-4">About Gaming Fonts</h2>
          <p className="text-gray-600 mb-4">
            Gaming fonts are specially designed to capture the energy and excitement of the gaming world. 
            These fonts are inspired by popular games and are perfect for creating usernames, clan tags, 
            and gaming-related content that stands out in the digital arena.
          </p>
