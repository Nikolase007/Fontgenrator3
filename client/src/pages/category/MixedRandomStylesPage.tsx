...
export default function MixedRandomStylesPage() {
  const [inputText, setInputText] = useState('Mixed Random Styles');
  
  const stylesByCategory = getStylesByCategory();
  const mixedStyles = stylesByCategory['Mixed Random Styles'] || [];
      ...
      <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <div className="text-center mb-12">
          <h1 className="text-4xl font-bold text-gray-900 mb-4">
            Mixed Random Styles Generator
          </h1>
          <p className="text-xl text-gray-600 mb-8">
            Explore a diverse collection of unique and experimental font styles
          </p>
        ...
        <div className="bg-white rounded-lg shadow-sm p-8 mb-8">
          <h2 className="text-2xl font-bold text-gray-900 mb-4">About Mixed Random Styles</h2>
          <p className="text-gray-600 mb-4">
            Mixed Random Styles offer a diverse collection of experimental and unique font variations. 
            This category combines different styling approaches to create unexpected and creative text 
            transformations that don't fit into traditional categories.
          </p>
